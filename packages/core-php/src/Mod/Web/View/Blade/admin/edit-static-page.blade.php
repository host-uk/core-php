    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-8">
        <div class="mb-4 sm:mb-0">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Edit static page</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Update your custom HTML page</p>
                </div>
            </div>
        </div>

        <div>
            <a href="{{ $biolink->full_url }}" target="_blank" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700">
        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <button
                    type="button"
                    wire:click="delete"
                    wire:confirm="Are you sure you want to delete this static page?"
                    class="px-4 py-2 text-sm font-medium text-red-700 dark:text-red-400 bg-red-50 dark:bg-red-900/20 border border-red-300 dark:border-red-800 rounded-md hover:bg-red-100 dark:hover:bg-red-900/30"
                >
                    Delete page
                </button>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button
                        type="submit"
                        class="px-4 py-2 text-sm font-medium text-white bg-violet-600 border border-transparent rounded-md hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-500"
                    >
                        Save changes
                    </button>
                </div>
