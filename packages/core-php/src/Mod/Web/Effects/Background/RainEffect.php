...
class RainEffect extends BackgroundEffect
{
    ...
    {
        return 'theme-backgrounds/rain.svg';
    }
...
CSS;
        ...
        // Return CSS + overlay HTML div
        return "<style>{$css}</style><div class=\"effect-overlay-rain\"></div>";
    }
}
